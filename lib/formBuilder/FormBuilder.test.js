...
import FormBuilder from "./FormBuilder"; // mocks to record events
...
describe("FormBuilder", () => {
  it("renders without error", () => {
    ...
    const wrapper = mount( /*#__PURE__*/React.createElement(FormBuilder, props), {
      attachTo: div
    });
  ...
  it("renders the appropriate number of cards", () => {
    ...
    const div = document.createElement("div");
    document.body.appendChild(div);
    const wrapper = mount( /*#__PURE__*/React.createElement(FormBuilder, modProps), {
      attachTo: div
    });
